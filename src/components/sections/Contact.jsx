...
export default function Contact() {
  return (
    <section id="contact" className="section">
      <h2>{portfolio.headings.contact}</h2>
      <div className="card contact-card">
        <p className="contact-command">{portfolio.contact.command}</p>
        <h3 className="contact-headline">{portfolio.contact.headline}</h3>
        <p className="contact-sub">{portfolio.contact.summary}</p>
